...
public class Result {
  ...
  public Result code(@javax.annotation.Nullable Integer code) {
    this.code = code;
    return this;
  }
  ...
  public Result message(@javax.annotation.Nullable String message) {
  ...
  public Result data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Result.openapiRequiredFields.isEmpty()) { // has required fields but CloudKeyJSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Result is not found in the empty JSON string", Result.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Result.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Result` properties. CloudKeyJSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static Result fromJson(String jsonString) throws IOException {
    return CloudKeyJSON.getGson().fromJson(jsonString, Result.class);
  }
